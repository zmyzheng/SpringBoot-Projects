...
@Slf4j
@Component
@Profile("default")   //意思是只有用application-default.properties时才用这个类
...
//    Default behavior of Spring Data repositories is to run each method call in a transaction.
//    By marking the service method as transactional, we pull the transaction boundaries to the service method,
//    thus correcting the lazy instantiate error.
    @Override
    @Transactional  //强制Create a transaction around this method, 把所有的操作放在一个transaction之内，防止lazy loading造成的报错
